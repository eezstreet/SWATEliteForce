...
public:
    ...
    FLOAT LowSkillMinTimeToFireFullAuto;
    FLOAT LowSkillMaxTimeToFireFullAuto;
    FLOAT MediumSkillMinTimeToFireFullAuto;
    FLOAT MediumSkillMaxTimeToFireFullAuto;
    FLOAT HighSkillMinTimeToFireFullAuto;
    FLOAT HighSkillMaxTimeToFireFullAuto;
    FLOAT MinDistanceToAffectMoraleOfOtherEnemiesUponDeath;
    TArrayNoInit<FName> ThrowWeaponDownAnimationsHG;
    TArrayNoInit<FName> ThrowWeaponDownAnimationsMG;
    TArrayNoInit<FName> ThrowWeaponDownAnimationsSMG;
    TArrayNoInit<FName> ThrowWeaponDownAnimationsSG;
    FLOAT LowSkillFullBodyHitChance;
    FLOAT MediumSkillFullBodyHitChance;
    FLOAT HighSkillFullBodyHitChance;
    ...
    class AEnemySpawner* SpawnedFrom;
...
{
public:
    class AHostageSpawner* SpawnedFrom;
    BYTE CurrentState;
...
public:
    ...
    FLOAT MinTimeToFireFullAuto;
    FLOAT MaxTimeToFireFullAuto;
...
public:
    ...
    FName ThrowShortAnimation;
    FName ThrowLongAnimation;
    FName ThrowAnimationRootBone;
    FLOAT ThrowAnimationTweenTime;
    FLOAT ThrowSpeedTimeFactor;
    FRange ThrowSpeedRange;
    class UMaterial* SuspectHandsMaterial;
    class UMaterial* VIPHandsMaterial;
    BITFIELD bTestingCameraEffects:1;
    ...
    FLOAT StingInputEffectMagnitude;
    FLOAT TasedViewEffectAmplitude;
    FLOAT TasedViewEffectFrequency;
    ...
    FLOAT LowReadyFireTweenTime;
    class IIAmReportableCharacter* CurrentReportableCharacter;
    BITFIELD bNotifiedPlayerTheyAreVIP:1;
    class ASwatPlayer* LastArrester;
    FVector OneFrameNudgeDirection;
    FLOAT LimpThreshold;
    FLOAT CurrentLimp;
    FLOAT StandardLimpPenalty;
    FStringNoInit YouString;
    FLOAT PawnModelApparentBaseEyeHeight;
    FLOAT PawnModelApparentCrouchEyeHeight;
    BITFIELD bHasBeenReportedToTOC:1;
...
public:
    ...
    FName FocusInterfaceType;
	   DECLARE_FUNCTION(execConsiderNewFocus);
...
public:
    ...
    TArrayNoInit<FName> CompleteMissionList;
    TArrayNoInit<FString> CompleteFriendlyNameList;
    class USwatMission* CurrentMission;
    TArrayNoInit<FName> MissionName;
    TArrayNoInit<FString> FriendlyName;
    TArrayNoInit<class UClass*> MissionEquipment;
    ...
    TArrayNoInit<FString> CommandString;
    TArrayNoInit<FString> LocalizedCommandString;
    TArrayNoInit<BYTE> CommandCategory;
    ...
    TArrayNoInit<FString> NetworkConnectionChoices;
    TArrayNoInit<INT> NetworkConnectionSpeeds;
...
AUTOGENERATE_FUNCTION(APlayerFocusInterface,-1,execConsiderNewFocus);
...
AUTOGENERATE_FUNCTION(ASwatPlayer,-1,execHasA);
