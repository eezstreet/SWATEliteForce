//=====================================================================
// Tests Tyrion sensors and inactive goals
//=====================================================================

class TyrionSensorsTest extends TyrionUnitTest;
...
Begin:
	...
	logTest("Tyrion Sensor Test started");
...
loop:
	...
	logTest("Tyrion Sensor Test finished");

	if ( true /* goal1.wasAchieved() && !goal2.wasAchieved() */)
		signalPassed();
	else
